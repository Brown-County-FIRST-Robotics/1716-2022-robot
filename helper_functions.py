...
def shoot(shooter_dictionary, motor_dictionary, speed = 1) -> dict:
    ...
    if shooter_dictionary["step"] == 2:
        angle =  <insert current degrees of shooter> (math.pi/180) #shooter angle in radians
